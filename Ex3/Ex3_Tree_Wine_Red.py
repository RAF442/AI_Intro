...
data = pd.read_csv('winequality-red.csv', sep=';') #ładowanie danych
...
class DecisionTreeClassifierCustom:
    def __init__(self, max_depth, min_samples_split):
        self.max_depth = max_depth #maksymalna głębokość drzewa
        self.min_samples_split = min_samples_split #liczba próbek w węźle, aby dzielić dalej
...
min_samples_splits = [2, 5, 10, 50, 100, 300]
...
#wykres
plt.title("Red wine decision tree accuracy for different values of max depth and minimum samples split")
